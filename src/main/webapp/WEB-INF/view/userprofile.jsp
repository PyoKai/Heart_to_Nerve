										...
										<c:forEach items="${userList}" var="list" varStatus="i">
											<div class="row d-flex align-items-center">
												...
												<div class="col-xl-4 col-md-4 d-flex justify-content-center">
													...
													<div class="infos text-secondary">
														<div class="row">
															<div class="col-md-2">
																<i class="fa fa-user"></i>
																<!-- Replace "fa-user" with the class of your desired icon -->
															</div>
															<div class="col-md-10">
																<h2>${list.name}</h2>
															</div>
														...
														<div class="row">
															<div class="col-md-2">
																...
																<!-- Replace "fa-envelope" with the class of your desired icon -->
															</div>
													...
													<div class="profile-details mx-auto">
														...
														<div class="row">
															<div class="col" style="text-align: center;">
																<a class="btn btn-primary" href="../edituser/${id}">Edit
																	Profile</a>
															</div>
														</div>
														<hr>
