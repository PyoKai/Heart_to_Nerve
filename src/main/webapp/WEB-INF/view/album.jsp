				...
				<div class="container-fluid">
					<div class="card shadow">
						<div
							...
							<p class="text-dark m-0 fw-bold me-auto">Album List</p>
							
							
							<button type="button" class="btn btn-primary "
										onclick="location.href ='albumaddform';"
						...
						<div class="table-responsive table mt-2" id="dataTable"
							...
							<table id="mytable" class="display" style="width: 100%">
								...
								<tbody>
									...
									<c:forEach items="${AlbumList}" var="list" varStatus="i">
										...
										<tr>
											...
											<td>
												<button class="btn btn-primary"
													onclick="location.href='albumupdateform/${list.id}'">
													Update</button>
											</td>
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content" style="background-color: white;">
													...
													<div class="modal-body ">Are you sure to delete this
														record?
														<div>If you delete, <span class="text-danger">song(s) related to this album</span> will be <span class="text-danger">deleted</span>.</div>
														</div>
													<div class="modal-footer">
														...
														<a class="btn btn-danger text-white"
															href="deletealbum/${list.id}">Yes</a>
